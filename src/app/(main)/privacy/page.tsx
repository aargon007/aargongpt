        ...
        <div className="min-h-screen bg-gradient-to-br from-noble-800 via-noble-700 to-noble-800">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="max-w-4xl mx-auto">
                    <div className="bg-noble-600/50 backdrop-blur-sm border border-noble-500 rounded-xl p-8">                        <h1 className="text-3xl font-bold text-white mb-8">Privacy Policy</h1>

                        <div className="prose prose-invert max-w-none">
                            <p className="text-gray-300 mb-6">Last updated: April 18, 2025</p>

                            <h2 className="text-xl font-semibold text-white mt-8 mb-4">1. Introduction</h2>
                            <p className="text-gray-300 mb-4">
                                Welcome to AargonGPT ("we," "our," or "us"). We are committed to protecting your privacy and ensuring
