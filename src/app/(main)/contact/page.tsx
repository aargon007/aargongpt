                                ...
                                <div className="bg-noble-600/50 rounded-xl border border-noble-500 p-6 backdrop-blur-xs">
                                    ...
                                    <div className="mt-8">
                                        ...
                                        <div className="flex space-x-4">
                                            <Link
                                                href="#"
                                                className="flex h-10 w-10 items-center justify-center rounded-full bg-noble-600 text-noble-300 transition-colors hover:bg-noble-500 hover:text-white"
                                            >
                                                <svg
                                                    className="h-5 w-5"
                                                    fill="currentColor"
                                ...
                                <div className="bg-noble-600/50 rounded-xl border border-noble-500 p-6 backdrop-blur-xs">
                                    ...
                                    >
                                        ...
                                        <div>
                                            <label
                                                htmlFor="message"
                                                className="mb-1 block text-sm font-medium text-noble-300"
                                            >
                                                Message
                                            </label>
                                            <textarea
